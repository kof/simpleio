...
Connection.prototype.open = function() {
    ...
    this._adapter.on('dispatch:' + this._recipient, add);

    this._off = function() {
        self._adapter.removeListener('dispatch:' + self._recipient, add);
    };

    // Load messages user has probably missed during reconnect.
    this._adapter.get(this._recipient, function(err, messages) {
    ...
    this._adapter.open(this._recipient, this._error.bind(this));
