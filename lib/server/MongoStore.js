...
MongoStore.prototype.publish = function(message, callback) {
    ...
    this.channel.publish(message, callback);
...
MongoStore.prototype.get = function(query, callback) {
...
MongoStore.prototype.toObjectId = function(ids) {
...
MongoStore.prototype.delivered = function(ids, value, publish, callback) {
    var self = this,
        todo = 1;
